...
Both of the aforementioned reasons require only a node in Ethereum, but the adversary themselves do not gain any reward from the attack.
...
Therefore, the adversary potentially gains more reward from including transactions with higher fees, available because of the attack.