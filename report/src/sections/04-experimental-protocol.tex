...
The output of this call returns the chosen validator's public key, ID, and the slot in which they are chosen to propose a block.
...
Also, the adversaries themselves gain little from this attack.
...
In the worst case, as the total amount of ether is dynamic, this could lead to a decrease in the total amount of ether.