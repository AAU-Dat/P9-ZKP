...
the way the proposer is chosen is through a random proses that is weighted by the amount of cryptocurrency the validator has staked and using the publicly available randao algorithm to simulate the random selection.
